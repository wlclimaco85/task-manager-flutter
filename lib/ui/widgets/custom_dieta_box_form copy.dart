  ...
  Widget form(int key) => Padding(
    ...
    child: Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          selected(key, "Titulo Plano", null, TextInputType.text, 'diaAtene'),
          const SelectedFormRefeicao(),
          buildItens(context),
          CustomComboBoxDietaitensForm(
            parentId: key,
            dataArray: _dataArrayMain,
          ),
        ],
      ),
    ),
    ...
    child: Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          imput(key, "Quantidade", null, TextInputType.number, 'quantidade'),
          //const SelectedFormUniMed(),
          selected(key, "Unidade Medida", null, TextInputType.text, 'diaAtene'),
        ],
      ),
    ),
  );
