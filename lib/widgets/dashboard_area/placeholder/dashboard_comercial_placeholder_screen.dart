...
class _DashboardComercialPlaceholderScreenState
  ...
  List<TendenciaFaturamentoModel> _tendencia = [];
  ...
  /// Gráfico de barras simples (6 meses faturamento).
  Widget _buildGraficoTendencia() {
    final maxValor = _tendencia
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Tendência de Faturamento (6 meses)',
            ...
            Align(
              alignment: Alignment.centerRight,
              child: Text(
                'Máx: R\$ ${(maxValor / 1000).toStringAsFixed(1)}k',
