...
/// Screen-casca leve do dashboard de área Atendimento (Fase 171 — fundação).
...
class _DashboardAtendimentoPlaceholderScreenState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Dashboard Atendimento (Área)')),
      body: Column(
        children: [
          const Padding(
          ...
          Expanded(
            child: DashboardAreaScaffold(
              titulo: 'Dashboard Atendimento (Área)',
              state: _state,
