class ApiLinks {
  ...
  // Defaults financeiros por empresa (importacao SINTEGRA/SPED) — card E2l56E5h
  static String defaultsImportacao(String empresaId) =>
      '$_baseUrlNew/api/defaults-importacao/$empresaId';
