...
/// Configurar recorrência de Conta a Receber (mobile) — mesma acao ja
/// existente no Web (ver web/dialogs/recorrencia_receber_dialog.dart).
enum TipoRecorrenciaReceber { semanal, mensal, anual }

class RecorrenciaReceberDialog extends StatefulWidget {
  final ContaReceber conta;

  const RecorrenciaReceberDialog({super.key, required this.conta});

  @override
  State<RecorrenciaReceberDialog> createState() => _RecorrenciaReceberDialogState();
}

class _RecorrenciaReceberDialogState extends State<RecorrenciaReceberDialog> {
  final _formKey = GlobalKey<FormState>();
  final _quantidadeController = TextEditingController();
  TipoRecorrenciaReceber _tipo = TipoRecorrenciaReceber.mensal;
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<TipoRecorrenciaReceber>(
                value: _tipo,
                ...
                items: const [
                  DropdownMenuItem(value: TipoRecorrenciaReceber.semanal, child: Text('Semanal')),
                  DropdownMenuItem(value: TipoRecorrenciaReceber.mensal, child: Text('Mensal')),
                  DropdownMenuItem(value: TipoRecorrenciaReceber.anual, child: Text('Anual')),
                ],
