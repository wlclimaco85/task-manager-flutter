...
/// Parcelar Conta a Pagar (mobile) — mesma acao ja existente no Web
/// (ver web/dialogs/parcelar_conta_dialog.dart), pedido do usuario pra
/// deixar o mobile com as mesmas opcoes de Contas a Pagar do web.
class ParcelarContaDialog extends StatefulWidget {
  final ContaPagar conta;

  const ParcelarContaDialog({super.key, required this.conta});

  @override
  State<ParcelarContaDialog> createState() => _ParcelarContaDialogState();
}

class _ParcelarContaDialogState extends State<ParcelarContaDialog> {
