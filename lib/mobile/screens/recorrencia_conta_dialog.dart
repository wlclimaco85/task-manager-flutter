...
/// Configurar recorrência de Conta a Pagar (mobile) — mesma acao ja
/// existente no Web (ver web/dialogs/recorrencia_conta_dialog.dart).
enum TipoRecorrenciaConta { semanal, mensal, anual }

class RecorrenciaContaDialog extends StatefulWidget {
  final ContaPagar conta;

  const RecorrenciaContaDialog({super.key, required this.conta});

  @override
  State<RecorrenciaContaDialog> createState() => _RecorrenciaContaDialogState();
}

class _RecorrenciaContaDialogState extends State<RecorrenciaContaDialog> {
  final _formKey = GlobalKey<FormState>();
  final _quantidadeController = TextEditingController();
  TipoRecorrenciaConta _tipo = TipoRecorrenciaConta.mensal;
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<TipoRecorrenciaConta>(
                value: _tipo,
                ...
                items: const [
                  DropdownMenuItem(value: TipoRecorrenciaConta.semanal, child: Text('Semanal')),
                  DropdownMenuItem(value: TipoRecorrenciaConta.mensal, child: Text('Mensal')),
                  DropdownMenuItem(value: TipoRecorrenciaConta.anual, child: Text('Anual')),
                ],
