...
/// Parcelar Conta a Receber (mobile) — mesma acao ja existente no Web
/// (ver web/dialogs/parcelar_receber_dialog.dart), pedido do usuario pra
/// deixar o mobile com as mesmas opcoes de Contas a Receber do web.
class ParcelarReceberDialog extends StatefulWidget {
  final ContaReceber conta;

  const ParcelarReceberDialog({super.key, required this.conta});

  @override
  State<ParcelarReceberDialog> createState() => _ParcelarReceberDialogState();
}

class _ParcelarReceberDialogState extends State<ParcelarReceberDialog> {
  ...
  void _submit() async {
    ...
    try {
      final response = await NetworkCaller().postRequest(
        ApiLinks.contaReceberParcelar(widget.conta.id.toString()),
        {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: const Text('Parcelar Conta a Receber'),
