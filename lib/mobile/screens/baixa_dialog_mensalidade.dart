...
class BaixaDialogMensalidade extends StatefulWidget {
  final dynamic mensalidade;

  const BaixaDialogMensalidade({super.key, required this.mensalidade});

  @override
  State<BaixaDialogMensalidade> createState() =>
      _BaixaDialogMensalidadeState();
}

class _BaixaDialogMensalidadeState extends State<BaixaDialogMensalidade> {
