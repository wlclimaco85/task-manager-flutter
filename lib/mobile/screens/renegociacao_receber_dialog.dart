...
/// Renegociar Conta a Receber (mobile) — mesma acao ja existente no Web
/// (ver web/dialogs/renegociacao_receber_dialog.dart).
class RenegociacaoReceberDialog extends StatefulWidget {
  final ContaReceber conta;

  const RenegociacaoReceberDialog({super.key, required this.conta});

  @override
  State<RenegociacaoReceberDialog> createState() => _RenegociacaoReceberDialogState();
}

class _RenegociacaoReceberDialogState extends State<RenegociacaoReceberDialog> {
