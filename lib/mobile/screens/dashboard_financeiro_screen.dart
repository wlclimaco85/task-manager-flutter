...
/// Dashboard Financeiro para Mobile
/// Integra dados reais do backend com layout responsivo para mobile
...
class _DashboardFinanceiroMobileScreenState
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          if (_projecao.isNotEmpty) const SizedBox(height: 16),
          _buildPieCharts(),
        ],
      ),
    );
  ...
  Widget _buildKpiCards() {
    final kpis = [
      ...
      _KpiData('Saldo', _saldoProjetado, Colors.blue.shade700, Icons.account_balance),
  ...
  Widget _buildKpiCard(_KpiData kpi) {
    ...
    final isNegative = kpi.valor < 0 && kpi.label != 'Saldo';
    return Card(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            Icon(kpi.icon, color: color, size: 24),
                    ...
                    leftTitles: AxisTitles(
                      sideTitles: SideTitles(
                        ...
                        getTitlesWidget: (value, meta) {
                          return Text(
                            _currency.format(value).replaceAll('R\$', '').substring(0, 5),
      ...
      children: [
        if (_categorias.isNotEmpty)
          Padding(
            ...
            child: _buildPieChartCard('Categorias', _categorias.map((c) => _PieData(c.nome, c.valor)).toList()),
          ),
        if (_topParceiros.isNotEmpty)
          _buildPieChartCard('Top Parceiros', _topParceiros.map((p) => _PieData(p.nome, p.valor)).toList()),
      ],
    );
  }
                ...
                return Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 4),
                      Expanded(
                        child: Text('${d.nome}: ${_currency.format(d.valor)}',
