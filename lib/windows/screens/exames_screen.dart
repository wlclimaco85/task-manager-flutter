...
class WindowsExameScreen extends StatefulWidget {
  const WindowsExameScreen({super.key});

  @override
  State<WindowsExameScreen> createState() => _ExameScreenState();
}
...
class _ExameScreenState extends State<WindowsExameScreen> {
  @override
  void initState() {
    findAllAcademia();
    super.initState();
