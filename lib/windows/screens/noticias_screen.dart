...
class WindowsProductCatalogPage extends StatefulWidget {
  final String title;
  final String apiUrl;
  final IconData actionIcon;
  final String actionTooltip;

  const WindowsProductCatalogPage({
    super.key,
    required this.title,
  ...
  @override
  _WindowsProductCatalogPageState createState() => _WindowsProductCatalogPageState();
}

class _WindowsProductCatalogPageState extends State<WindowsProductCatalogPage> {
