...
class WindowsTaskScreens extends StatefulWidget {
  ...
  @override
  State<WindowsTaskScreens> createState() => _TaskScreenState();
}
...
class _TaskScreenState extends State<WindowsTaskScreens> {
  List<Data> newsList = [];
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    WindowsNewsDetailScreen(news: news),
                              ),
                            );
                          },
                        ),
