...
class WindowsProductRegisterScreen extends StatefulWidget {
  const WindowsProductRegisterScreen({super.key});

  @override
  _WindowsProductRegisterScreenState createState() => _WindowsProductRegisterScreenState();
}

class _WindowsProductRegisterScreenState extends State<WindowsProductRegisterScreen> {
