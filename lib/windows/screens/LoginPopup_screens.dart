...
class WindowsLoginPopup extends StatefulWidget {
  const WindowsLoginPopup({super.key});

  @override
  _WindowsLoginPopupState createState() => _WindowsLoginPopupState();
}

class _WindowsLoginPopupState extends State<WindowsLoginPopup> {
  ...
  void _navigateToForgotPassword() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const WindowsForgotPasswordScreen()),
    );
  }
  ...
  void _navigateToSignUp() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const WindowsSignUpScreen()),
    );
  }
