...
/// Aba de cobrança de módulos do parceiro (versão Windows).
...
class WindowsModuloCobrancaScreen extends StatefulWidget {
  final int parceiroId;
  final String parceiroNome;

  const WindowsModuloCobrancaScreen({
    super.key,
  ...
  @override
  State<WindowsModuloCobrancaScreen> createState() => _WindowsModuloCobrancaScreenState();
}

class _WindowsModuloCobrancaScreenState extends State<WindowsModuloCobrancaScreen> {
                    ...
                    child: emEdicaoValor
                        ...
                        : GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Text('$valorAtual', style: const TextStyle(cursor: SystemMouseCursors.click)),
                            ),
                          ),
                  ),
                    ...
                    child: emEdicaoDia
                        ...
                        : GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Text('$diaAtual', style: const TextStyle(cursor: SystemMouseCursors.click)),
                            ),
                          ),
                  ),
                ],
