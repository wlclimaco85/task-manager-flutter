...
class WindowsNfeGridScreen extends StatefulWidget {
  final bool entrada;
  const WindowsNfeGridScreen({super.key, required this.entrada});
  @override
  State<WindowsNfeGridScreen> createState() => _WindowsNfeGridScreenState();
}

class _WindowsNfeGridScreenState extends State<WindowsNfeGridScreen> {
  ...
  Future<void> _aplicarFiltros() async {
    ...
    // CNPJ tem prioridade sobre os filtros de nome (parceiro/destinatário),
    // pois o backend só filtra por parceiroId (não por texto livre).
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 8),
          _lbl('CNPJ do Parceiro/Destinatário'),
          TextField(
          ...
          if (_cnpjErro != null)
            Padding(
              ...
              child: Text(_cnpjErro!,
                  style:
                      const TextStyle(fontSize: 11, color: GridColors.error)),
            ),
          const SizedBox(height: 8),
          _lbl('Status'),
          _drop(
