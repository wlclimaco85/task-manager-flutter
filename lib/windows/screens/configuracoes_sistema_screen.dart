...
class _ConfiguracoesSistemaScreenState
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Row(children: [
          ...
          SizedBox(width: 8),
          Text(GridTexts.systemSettingsTitle,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          _section(GridTexts.screenGeneration, Icons.table_chart_outlined, [
            _actionCard(
                id: 'gerar_telas_full',
                title: GridTexts.generateScreensFullReset,
            ...
            _actionCard(
                ...
                title: GridTexts.updateScreensForce,
            ...
            _actionCard(
                id: 'regenerar_telas',
                title: GridTexts.regenerateScreensAdmin,
            ...
            _actionCard(
                ...
                title: GridTexts.clearScreensCache,
          ...
          _section(GridTexts.news, Icons.newspaper, [
            _actionCard(
                ...
                title: GridTexts.clearAndDownloadNews,
          ...
          _section(GridTexts.database, Icons.storage_outlined, [
            _actionCard(
                id: 'db_status',
                title: GridTexts.databaseStatus,
            ...
            _actionCard(
                id: 'fix_db',
                title: GridTexts.fixDatabase,
                subtitle: GridTexts.fixDatabaseDesc,
                icon: Icons.build_outlined,
                color: GridColors.statusClosed,
                onTap: _fixDb),
            _actionCard(
                id: 'reset_database',
                title: GridTexts.resetDatabase,
    ...
    return Card(
      ...
      child: ListTile(
        ...
        subtitle:
          ...
          Text(subtitle,
              style:
                  const TextStyle(fontSize: 11, color: GridColors.textMuted)),
          if (resultado != null) ...[
          ...
          child:
            ...
            Row(children: [
              Container(
                  ...
                  height: 40,
                  decoration: BoxDecoration(
                      color: GridColors.secondaryDark.withValues(alpha: 0.1),
                      borderRadius: BorderRadius.circular(8)),
                  child: const Icon(Icons.science_outlined,
                      color: GridColors.secondaryDark, size: 20)),
              const SizedBox(width: 12),
              const Expanded(
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                    Text(GridTexts.generateMockData,
                        style: TextStyle(
            ...
            Row(children: [
              Expanded(
                  child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                          labelText: GridTexts.companyIdOptionalCreate,
              ...
              Expanded(
                  child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                          labelText: GridTexts.baseQuantity,
                          border: OutlineInputBorder(),
                          isDense: true,
                          contentPadding: EdgeInsets.symmetric(
                              horizontal: 10, vertical: 8)),
            ...
            Row(children: [
              Expanded(
                  child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                          labelText: GridTexts.historyMonths,
                          border: OutlineInputBorder(),
                          isDense: true,
                          contentPadding: EdgeInsets.symmetric(
                              horizontal: 10, vertical: 8)),
              ...
              ElevatedButton.icon(
                  ...
                  label: Text(
                      isLoading ? GridTexts.generating : GridTexts.generate),
                  style: ElevatedButton.styleFrom(
                      backgroundColor: GridColors.secondaryDark,
                      foregroundColor: _white,
  ...
  Widget _buildResultados() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      const Divider(),
      const Text(GridTexts.latestResults,
          ...
          child:
            ...
            Row(children: [
              ...
              const Expanded(
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                    Text(GridTexts.deleteMockCompany,
                        style: TextStyle(
                            fontWeight: FontWeight.w600, fontSize: 14)),
            ...
            Row(children: [
              ...
              ElevatedButton.icon(
                  ...
                  label:
                      Text(isLoading ? GridTexts.deleting : GridTexts.delete),
                  style: ElevatedButton.styleFrom(
                      backgroundColor: _primary,
                      foregroundColor: _white,
                      padding: const EdgeInsets.symmetric(
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(GridTexts.irreversibleWarning,
                  style: TextStyle(
                      color: GridColors.error,
...
class _JobsSectionState extends State<_JobsSection> {
              ...
              children: [
                ...
                Align(
                  ...
                  child: TextButton.icon(
                      ...
                      label: const Text(GridTexts.copyAll,
  ...
  void _copiar(BuildContext ctx, String texto) {
    ...
    ScaffoldMessenger.of(ctx).showSnackBar(const SnackBar(
        content: Text(GridTexts.copied), duration: Duration(seconds: 2)));
  }
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        ...
        const SizedBox(width: 8),
        const Text(GridTexts.jobsControlTitle,
            style: TextStyle(
                fontSize: 16, fontWeight: FontWeight.bold, color: _primary)),
        const Spacer(),
        if (_carregando)
                ...
                child: Column(
                  ...
                  Row(children: [
                    const Icon(Icons.timer_outlined,
                        size: 11, color: GridColors.textMuted),
                    ...
                    if (status != null)
                      ...
                      const Text(GridTexts.neverExecuted,
                          style: TextStyle(
            ...
            Row(mainAxisSize: MainAxisSize.min, children: [
              IconButton(
                  icon: Icon(histAberto ? Icons.expand_less : Icons.history,
                      size: 18),
                  tooltip: GridTexts.jobHistoryTooltip,
                  color: GridColors.info,
          ...
          Padding(
            ...
            child: InkWell(
              ...
              child: Row(children: [
                ...
                Text(erroAberto ? GridTexts.hideError : GridTexts.viewFullError,
                    style: const TextStyle(
                        fontSize: 11,
                        color: _primary,
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(children: [
                          const Text(GridTexts.errorTitle,
                              style: TextStyle(
                                  fontSize: 11,
                                  fontWeight: FontWeight.bold,
                                  color: _primary)),
                          ...
                          TextButton.icon(
                              ...
                              label: const Text(GridTexts.copy,
        ...
        if (histAberto) ...[
          ...
          if (_historicos[nome] == null || _historicos[nome]!.isEmpty)
            const Padding(
                ...
                child: Text(GridTexts.noHistoryAvailable,
                    style:
                        TextStyle(fontSize: 11, color: GridColors.textMuted)))
          else
