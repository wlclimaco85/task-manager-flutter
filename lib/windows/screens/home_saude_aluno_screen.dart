...
/// Tela de Home Saúde do Aluno — V003 Fitness (Windows).
/// Exibe: boas-vindas, peso + IMC da avaliação mais recente,
/// último treino registrado. Dados reais do backend via GET.
class WindowsHomeSaudeAlunoScreen extends StatefulWidget {
  const WindowsHomeSaudeAlunoScreen({super.key});

  @override
  State<WindowsHomeSaudeAlunoScreen> createState() =>
      _WindowsHomeSaudeAlunoScreenState();
}

class _WindowsHomeSaudeAlunoScreenState
    extends State<WindowsHomeSaudeAlunoScreen> {
