...
class WindowsProductCatalogPageCompras extends StatefulWidget {
  final String title;
  final String apiUrl;
  final IconData actionIcon;
  final String actionTooltip;

  const WindowsProductCatalogPageCompras({
    super.key,
    required this.title,
  ...
  @override
  _WindowsProductCatalogPageComprasState createState() =>
      _WindowsProductCatalogPageComprasState();
}

class _WindowsProductCatalogPageComprasState extends State<WindowsProductCatalogPageCompras> {
  ...
  void main() {
    runApp(
      MaterialApp(
        ...
        home: WindowsProductCatalogPageCompras(
