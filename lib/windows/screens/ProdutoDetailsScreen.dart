...
// Tela de Detalhes
class WindowsProdutoDetailsScreen extends StatefulWidget {
  final int produtoId;

  const WindowsProdutoDetailsScreen({super.key, required this.produtoId});

  @override
  State<WindowsProdutoDetailsScreen> createState() => _WindowsProdutoDetailsScreenState();
}

class _WindowsProdutoDetailsScreenState extends State<WindowsProdutoDetailsScreen> {
