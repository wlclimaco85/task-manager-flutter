...
class WindowsFileAttachmentGridScreen extends StatelessWidget {
  final SecurityCheck hasPermission;

  const WindowsFileAttachmentGridScreen({super.key, required this.hasPermission});

  @override
  Widget build(BuildContext context) {
    return DynamicGridWindowsScreen<FileAttachment>(
      telaNome: 'Arquivos', // nome da tela no banco
