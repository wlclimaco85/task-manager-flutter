...
class WindowsCheckoutScreen extends StatefulWidget {
  ...
  @override
  _WebCheckoutScreenState createState() => _WebCheckoutScreenState();
}

class _WebCheckoutScreenState extends State<WindowsCheckoutScreen> {
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  if (_termsAccepted) {
                    ...
                    if (response) {
                      final response =
                          await RenegotiationMovimentoContratosHandler
                              .renegotiates(
                        context: context, // Contexto do widget atual
