...
class PedidoCompraHistoricoDialog extends StatelessWidget {
  final List<PedidoCompraHistorico> historico;

  const PedidoCompraHistoricoDialog({super.key, required this.historico});
    ...
    return Dialog(
      ...
      child: ConstrainedBox(
        ...
        child: Column(
          children: [
            AppBar(
              title: const Text('Histórico do Pedido de Compra'),
