...
class PedidoVendaHistoricoDialog extends StatelessWidget {
  final List<PedidoVendaHistorico> historico;

  const PedidoVendaHistoricoDialog({super.key, required this.historico});
