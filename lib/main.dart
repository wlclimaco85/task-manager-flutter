    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(
          ...
          primaryFixed: GridColors.primarySoft,
          primaryFixedDim: GridColors.primaryLight,
          onPrimaryFixed: GridColors.primaryDark,
          onPrimaryFixedVariant: GridColors.primary,
          ...
          secondaryFixed: GridColors.secondarySoft,
          secondaryFixedDim: GridColors.secondaryLight,
          onSecondaryFixed: GridColors.secondaryDark,
          onSecondaryFixedVariant: GridColors.secondary,
          tertiary: GridColors.secondary,
          onTertiary: Colors.white,
          tertiaryContainer: GridColors.secondarySoft,
          onTertiaryContainer: GridColors.secondaryDark,
          tertiaryFixed: GridColors.secondarySoft,
          tertiaryFixedDim: GridColors.secondaryLight,
          onTertiaryFixed: GridColors.secondaryDark,
          onTertiaryFixedVariant: GridColors.secondary,
          surfaceDim: GridColors.divider,
          ...
          onSurfaceVariant: GridColors.textMuted,
          inverseSurface: GridColors.primaryDark,
          onInverseSurface: Colors.white,
          inversePrimary: GridColors.primaryLight,
