...
import '../../../services/renegociacao_receber_service.dart';
import '../../../utils/api_links.dart';

class WebRenegociacaoReceberDialog extends StatefulWidget {
  final ContaReceber conta;

  const WebRenegociacaoReceberDialog({super.key, required this.conta});

  @override
  State<WebRenegociacaoReceberDialog> createState() => _WebRenegociacaoReceberDialogState();
}

class _WebRenegociacaoReceberDialogState extends State<WebRenegociacaoReceberDialog> {
  ...
  void _submit() async {
    ...
    try {
      ...
      final response = await NetworkCaller().postRequest(
        ApiLinks.contaReceberRenegociar(widget.conta.id.toString()),
        body,
      );
      if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: const Text('Renegociar Conta a Receber'),
