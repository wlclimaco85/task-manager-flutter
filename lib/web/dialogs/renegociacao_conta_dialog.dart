...
class WebRenegociacaoContaDialog extends StatefulWidget {
  ...
  const WebRenegociacaoContaDialog({super.key, required this.conta});

  @override
  State<WebRenegociacaoContaDialog> createState() => _WebRenegociacaoContaDialogState();
}

class _WebRenegociacaoContaDialogState extends State<WebRenegociacaoContaDialog> {
