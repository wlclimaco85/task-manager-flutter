...
class WebParcelarReceberDialog extends StatefulWidget {
  ...
  const WebParcelarReceberDialog({super.key, required this.conta});

  @override
  State<WebParcelarReceberDialog> createState() => _WebParcelarReceberDialogState();
}

class _WebParcelarReceberDialogState extends State<WebParcelarReceberDialog> {
