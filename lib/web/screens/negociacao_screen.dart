...
class WebNegociacaoCatalogPage extends StatefulWidget {
  final String title;
  final String apiUrl;
  final IconData actionIcon;
  final String actionTooltip;

  const WebNegociacaoCatalogPage({
    super.key,
    required this.title,
  ...
  @override
  _WebNegociacaoCatalogPageState createState() => _WebNegociacaoCatalogPageState();
}

class _WebNegociacaoCatalogPageState extends State<WebNegociacaoCatalogPage> {
