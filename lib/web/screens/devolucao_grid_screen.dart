...
class WebDevolucaoGridScreen extends StatefulWidget {
  const WebDevolucaoGridScreen({super.key});

  @override
  State<WebDevolucaoGridScreen> createState() =>
      _WebDevolucaoGridScreenState();
}

class _WebDevolucaoGridScreenState extends State<WebDevolucaoGridScreen> {
    ...
    return SingleChildScrollView(
      child: DataTable(
        ...
        columns: const [
          ...
          DataColumn(
            label: Text(
              GridTexts.customerColumn,
              style: TextStyle(fontWeight: FontWeight.bold),
            ),
          ),
          DataColumn(
            label: Text(
              GridTexts.sourceDocumentColumn,
              style: TextStyle(fontWeight: FontWeight.bold),
            ),
          ),
          DataColumn(
  ...
  String _tipoLabel(String tipo) {
    switch (tipo) {
      case 'DEVOLUCAO_VENDA':
        return GridTexts.saleReturnType;
      case 'DEVOLUCAO_COMPRA':
        return GridTexts.purchaseReturnType;
      default:
        return tipo;
    }
  }
    ...
    return Row(
      ...
      children: [
        _actionIcon(
          ...
          GridTexts.view,
          GridColors.info,
          () => _openForm(_devolucoes.firstWhere((o) => o['id'] == id)),
        ),
        if (status == 'RASCUNHO') ...[
          _actionIcon(
            Icons.edit,
          ...
          _actionIcon(
            ...
            Colors.green,
            () => _confirmAction(
              GridTexts.concludeReturnTitle,
              GridTexts.concludeReturnQuestion,
              () => DevolucaoService.concluir(id),
            ),
          ),
          _actionIcon(
            Icons.block,
            ...
            Colors.orange,
            () => _confirmAction(
              GridTexts.cancelReturnTitle,
              GridTexts.cancelReturnQuestion,
