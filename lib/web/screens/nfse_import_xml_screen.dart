...
class _WebNfseImportXmlScreenState extends State<WebNfseImportXmlScreen> {
  ...
  Future<void> _selecionarXml() async {
    try {
      ...
      AppLogger.i
          .error('WebNfseImportXmlScreen: erro ao selecionar arquivo', st);
  ...
  Future<void> _carregarPreview() async {
    ...
    if (result.success) {
      ...
      AppLogger.i
          .warn('WebNfseImportXmlScreen: preview falhou -- ${result.message}');
      setState(() {
        _carregando = false;
        _sucesso = false;
  ...
  Future<void> _confirmarImportacao(
    ...
    if (!result.success) {
      AppLogger.i.warn(
          'WebNfseImportXmlScreen: confirmacao falhou -- ${result.message}');
    }
