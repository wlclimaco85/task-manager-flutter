...
class WebCotacaoScreen extends StatefulWidget {
  const WebCotacaoScreen({super.key});

  @override
  _WebCotacaoScreenState createState() => _WebCotacaoScreenState();
}

class _WebCotacaoScreenState extends State<WebCotacaoScreen> {
