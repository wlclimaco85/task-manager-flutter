              ...
              TextButton.icon(
                ...
                onPressed: () async {
                  ...
                  Future.delayed(const Duration(seconds: 2), () {
                    if (ctx.mounted) setDialogState(() => _copied = false);
                  });
                },
              ),
              TextButton(
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Testa fetch/create/update/delete de cada tela cadastrada.',
                        style: TextStyle(color: Colors.white70, fontSize: 13)),
                    const SizedBox(height: 2),
                    const Text('Os endpoints e campos vêm direto do backend.',
