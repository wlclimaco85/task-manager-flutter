...
class WebProductCatalogPageVendas extends StatefulWidget {
  final String title;
  final String apiUrl;
  final IconData actionIcon;
  final String actionTooltip;

  const WebProductCatalogPageVendas({
    super.key,
    required this.title,
  ...
  @override
  _WebProductCatalogPageVendasState createState() =>
      _WebProductCatalogPageVendasState();
}

class _WebProductCatalogPageVendasState extends State<WebProductCatalogPageVendas> {
...
void main() {
  runApp(
    MaterialApp(
      ...
      home: WebProductCatalogPageVendas(
