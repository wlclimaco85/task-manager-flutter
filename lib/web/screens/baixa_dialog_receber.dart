...
/// Popup "Registrar Baixa" de Conta a Receber (Web).
...
class WebBaixaDialogReceber extends StatefulWidget {
  final ContaReceber conta;

  const WebBaixaDialogReceber({super.key, required this.conta});

  @override
  State<WebBaixaDialogReceber> createState() => _WebBaixaDialogReceberState();
}

class _WebBaixaDialogReceberState extends State<WebBaixaDialogReceber> {
