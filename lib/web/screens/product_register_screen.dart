...
class WebProductRegisterScreen extends StatefulWidget {
  const WebProductRegisterScreen({super.key});

  @override
  _WebProductRegisterScreenState createState() => _WebProductRegisterScreenState();
}

class _WebProductRegisterScreenState extends State<WebProductRegisterScreen> {
