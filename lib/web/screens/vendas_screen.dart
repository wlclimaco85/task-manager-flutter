...
import '../../../widgets/freteWidget.dart';

class WebProductCatalog extends StatefulWidget {
  const WebProductCatalog({super.key});

  @override
  _WebProductCatalogState createState() => _WebProductCatalogState();
}

class _WebProductCatalogState extends State<WebProductCatalog> {
