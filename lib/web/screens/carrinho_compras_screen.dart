...
class WebProductCatalogPageCompras extends StatefulWidget {
  final String title;
  final String apiUrl;
  final IconData actionIcon;
  final String actionTooltip;

  const WebProductCatalogPageCompras({
    super.key,
    required this.title,
  ...
  @override
  _WebProductCatalogPageComprasState createState() =>
      _WebProductCatalogPageComprasState();
}

class _WebProductCatalogPageComprasState extends State<WebProductCatalogPageCompras> {
  ...
  void main() {
    runApp(
      MaterialApp(
        ...
        home: WebProductCatalogPageCompras(
